...
#else
	kNIMVideoChatSessionTypeAuMixingEventNotify		=30,	/**< 通话中伴音事件状态通知*/
	kNIMVideoChatSessionTypeAuDeviceChangedNotify	=31,	/**< 音频设备变化*/
	kNIMVideoChatSessionTypeNetConnectionTypeChangedNotify =32,		/**<客户端网络类型发生了变化*/
	kNIMVideoChatSessionTypeDeviceEventNotify		=33,			/**<语音采集设备和视频采集设备事件通知*/
	kNIMVideoChatSessionTypeAudioMuteStatus			=34				/**<语音静音状态*/
#endif
};
...
static const char *kNIMVChatRecordType		= "record_type";	/**< int 服务器录制模式NIMVChatServRecordType，默认为0 （需要服务器配置支持，并且开kNIMVChatRecord，kNIMVChatSingleRecord其中一个）*/
...
static const char *kNIMVChatAudioCallProximity = "audio_call_proximity"; /**< int 是否允许语音通话时开启距离感应器 >0表示是 默认否 */
static const char *kNIMVChatReportVolumes = "audio_report_volume"; /**< int 是否允许语音通话时上报音量值 >0表示是 默认否 */
static const char *kNIMVChatReportStatisticsInfo = "audio_report_statistics"; /**< int 是否允许语音通话时上报通话统计信息 >0表示是 默认否 */
static const char *kNIMVChatLowEnergy = "vchat_low_energy";/**<int 是否开启低能耗模式，开启后音频编解码器为g711,采样率为8k >0表示是,默认否 */
